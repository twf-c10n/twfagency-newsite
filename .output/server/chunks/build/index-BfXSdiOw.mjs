globalThis.__timing__.logStart('Load chunks/build/index-BfXSdiOw');import { _ as __nuxt_component_0 } from './SiteHeader-D9ODwCeG.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-CrsJHC3p.mjs';
...
import { b as getOurProjectsPage, p as pickLocalizedText, a as getMediaUrl } from './api-OwmsrwqD.mjs';
import { u as useHead, g as getAbsoluteUrl, k as useRuntimeConfig } from './server.mjs';
import { u as useAsyncData } from './fetch-hDAz9q5R.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main>`);
      if (unref(isPending)) {
        _push(`<!--[--><section class="project-hero" aria-busy="true"><span class="skeleton-bar skeleton-hero-title"></span><span class="skeleton-bar skeleton-hero-desc"></span><span class="skeleton-bar skeleton-hero-desc" style="${ssrRenderStyle({ "width": "65%" })}"></span></section><section class="project-categories" aria-label="Loading categories" aria-busy="true"><!--[-->`);
        ssrRenderList(8, (i) => {
          _push(`<span class="project-cat-skeleton"></span>`);
        });
        _push(`<!--]--></section><section class="project-services"><div class="project-service-copy"><span class="skeleton-bar skeleton-bar--title"></span><span class="skeleton-bar skeleton-bar--body"></span><span class="skeleton-bar skeleton-bar--body" style="${ssrRenderStyle({ "width": "60%" })}"></span></div><div class="project-card-grid"><!--[-->`);
        ssrRenderList(6, (i) => {
          _push(`<article class="project-card has-media skeleton-card" aria-hidden="true"><div class="project-card-media"><span class="media-skeleton skeleton-media-placeholder"></span></div><div class="project-card-body"><span class="skeleton-bar"></span><span class="skeleton-bar skeleton-bar--short"></span></div></article>`);
        });
        _push(`<!--]--></div></section><!--]-->`);
      } else if (unref(showErrorState)) {
        _push(`<p class="project-status" role="status"> Project data is unavailable. </p>`);
      } else {
        _push(`<!--[--><section class="project-hero"><h1>${ssrInterpolate(unref(heroTitle))}</h1><p>${ssrInterpolate(unref(heroDescription))}</p></section><section class="project-categories" aria-label="Project categories"><!--[-->`);
        ...
        _push(`<!--]--></section><section class="project-services"${ssrRenderAttr("aria-labelledby", `${unref(activeCategory).id}-title`)}><div class="project-service-copy"><h2${ssrRenderAttr("id", `${unref(activeCategory).id}-title`)}>${ssrInterpolate(unref(activeCategory).title)}</h2><p>${ssrInterpolate(unref(activeCategory).description)}</p></div>`);
...
export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/index-BfXSdiOw');
//# sourceMappingURL=index-BfXSdiOw.mjs.map
