globalThis.__timing__.logStart('Load chunks/build/about-Ctu1C8P0');import { defineComponent, ref, mergeProps, unref, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderClass, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderStyle } from 'vue/server-renderer';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page about-figma-page" }, _attrs))}><header class="${ssrRenderClass(["site-header about-figma-header", { scrolled: unref(headerScrolled) }])}"><nav class="about-figma-nav" aria-label="Primary navigation"><a class="about-logo" href="/#home" aria-label="TWF home"><img${ssrRenderAttr("src", `${assetPath}/twf-logo.svg`)} alt="TWF"></a><div class="${ssrRenderClass(["nav-links about-figma-links", { open: unref(menuOpen) }])}"><!--[-->`);
...
export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/about-Ctu1C8P0');
//# sourceMappingURL=about-Ctu1C8P0.mjs.map
