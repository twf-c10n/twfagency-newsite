...
const _imports_2 = publicAssetsURL("/assets/triangle-performance-main.webp");
const _imports_3 = publicAssetsURL("/assets/triangle-performance-main.png");
const _imports_4 = publicAssetsURL("/assets/triangle-performance-grid.webp");
const _imports_5 = publicAssetsURL("/assets/triangle-performance-grid.png");
const _imports_6 = publicAssetsURL("/assets/triangle-performance-glow.webp");
const _imports_7 = publicAssetsURL("/assets/triangle-performance-glow.png");
const _imports_8 = publicAssetsURL("/assets/triangle-twf-logo.svg");
const _imports_9 = publicAssetsURL("/assets/orbit.png");
const _imports_10 = publicAssetsURL("/assets/showreel-reference.png");
const _imports_11 = publicAssetsURL("/assets/stellar-data.png");
const _imports_12 = publicAssetsURL("/assets/kensento.png");
const _imports_13 = publicAssetsURL("/assets/award.png");
const _imports_14 = publicAssetsURL("/assets/team.png");
const _imports_15 = publicAssetsURL("/assets/article-cover.png");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div></div><div class="orbit-art" data-reveal style="${ssrRenderStyle({ "--delay": ".18s" })}" aria-hidden="true"><img${ssrRenderAttr("src", _imports_9)} alt=""></div></div></section><section id="photography" class="${ssrRenderClass(["showreel", { "is-active": unref(showreelActive) }])}"><div class="showreel-stage"><figure class="showreel-frame" data-reveal><div class="media-skeleton showreel-skeleton" aria-hidden="true"></div><img class="showreel-poster"${ssrRenderAttr("src", _imports_10)} alt="" aria-hidden="true"><video muted loop playsinline preload="none"${ssrRenderAttr("poster", _imports_10)} aria-label="Capturing Vision. Executing Perfection. Watch 2026 showreel"><source data-src="/assets/showreel.mp4" type="video/mp4"></video></figure></div></section><section id="projects" class="products"><div class="shell products-inner"><p class="accent-copy" data-reveal>Venture Beyond Your Limits</p><h2 data-reveal style="${ssrRenderStyle({ "--delay": ".08s" })}">Our Innovative Product<br>and Services</h2><div class="product-grid"><article data-reveal style="${ssrRenderStyle({ "--delay": ".14s" })}"><img${ssrRenderAttr("src", _imports_11)} alt="Stellar Data"><p>Elevate your performance marketing campaigns</p></article><article data-reveal style="${ssrRenderStyle({ "--delay": ".22s" })}"><img${ssrRenderAttr("src", _imports_12)} alt="Kensento"><p>Taking you beyond cookies consent management</p></article></div></div></section><section id="about" class="team"><div class="shell team-grid"><div class="team-photos" data-reveal><img${ssrRenderAttr("src", _imports_13)} alt="TWF awards"><img${ssrRenderAttr("src", _imports_14)} alt="TWF team"></div><div class="team-copy" data-reveal style="${ssrRenderStyle({ "--delay": ".14s" })}"><h2>A team you<br>can trust</h2><p> We push boundaries and strive for excellence by fostering a highly collaborative and constructive environment. Our team is comprised of talented individuals who work hard to elevate your brand. </p></div></div></section><section id="blog" class="articles"><div class="shell"><p class="caption" data-reveal>Our Expertise</p><h2 data-reveal style="${ssrRenderStyle({ "--delay": ".08s" })}">Explore our recent articles</h2><p class="article-tags" data-reveal style="${ssrRenderStyle({ "--delay": ".12s" })}">Performance Marketing · Social Media · Case Study · Media Plan &amp; Buy · Digital Campaign</p><div class="article-grid"><!--[-->`);
      ssrRenderList(articles, (article, index) => {
        _push(`<article data-reveal style="${ssrRenderStyle({ "--delay": `${160 + index * 75}ms` })}"><img${ssrRenderAttr("src", _imports_15)} alt=""><div><p>LINE Commerce</p><h3>${ssrInterpolate(article)}</h3><a href="#blog">Click Here <b>+</b></a></div></article>`);
      });
...
//# sourceMappingURL=index-Dpe6JotL.mjs.map
