globalThis.__timing__.logStart('Load chunks/build/blog-BogU7Kbu');import { _ as __nuxt_component_0 } from './SiteHeader-D9ODwCeG.mjs';
import { defineComponent, mergeProps, unref, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrInterpolate } from 'vue/server-renderer';
import { h as usePageSeo } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    usePageSeo({
      ...
      description: "Read digital marketing, LINE Commerce, media, creative, and performance marketing articles from TWF Agency.",
      path: "/blog",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main><h1 class="visually-hidden">Digital Marketing Blog by TWF Agency</h1><section class="blog-search-section" aria-label="Blog search"><form class="blog-search-pill" action="/blog" role="search"><input type="search" name="q" aria-label="Search articles" placeholder="Search"><button type="submit" aria-label="Search"><span>Search</span><b aria-hidden="true">→</b></button></form></section><section class="blog-list-section" aria-label="Articles"><div class="blog-card-grid"><!--[-->`);
      ssrRenderList(unref(articles), (article) => {
        _push(`<article class="blog-card"><figure class="blog-card-media"><img${ssrRenderAttr("src", `${blogAssetPath}/article-product.webp`)} alt="" loading="lazy" decoding="async"><img${ssrRenderAttr("src", `${blogAssetPath}/article-gradient.webp`)} alt="" loading="lazy" decoding="async"></figure><div class="blog-card-body"><p>${ssrInterpolate(article.category)}</p><h2>${ssrInterpolate(article.title)}</h2><a${ssrRenderAttr("href", article.href)}><span>Click Here</span><b aria-hidden="true">→</b></a></div></article>`);
      });
      _push(`<!--]--></div><a class="blog-more-button"${ssrRenderAttr("href", blogListingUrl)}><span>บทความเพิ่มเติม</span><b aria-hidden="true">→</b></a></section></main><footer class="about-figma-footer"><div class="about-footer-inner"><div class="about-footer-address"><img${ssrRenderAttr("src", `${aboutAssetPath}/twf-logo-footer.svg`)} alt="TWF"><p> The Web Flight Co., Ltd., Capital Work Place Building, Fl. 8, 1<br> Soi Chamchan, Klongton-neur, Wattana, Bangkok 10110 </p></div><div class="about-footer-socials"><!--[-->`);
...
export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/blog-BogU7Kbu');
//# sourceMappingURL=blog-BogU7Kbu.mjs.map
