globalThis.__timing__.logStart('Load chunks/build/services-B7LR10h-');import { _ as __nuxt_component_0 } from './SiteHeader-D9ODwCeG.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    usePageSeo({
      ...
      description: "Explore TWF Agency services across media strategy, performance marketing, creative solutions, CRM, influencer marketing, analytics, and LINE business solutions.",
      path: "/services",
...
export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/services-B7LR10h-');
//# sourceMappingURL=services-B7LR10h-.mjs.map
