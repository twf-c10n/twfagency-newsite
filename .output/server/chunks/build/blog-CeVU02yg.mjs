globalThis.__timing__.logStart('Load chunks/build/blog-CeVU02yg');import { _ as __nuxt_component_0 } from './SiteHeader-D9ODwCeG.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(articles), (article) => {
        _push(`<article class="blog-card"><figure class="blog-card-media"><img${ssrRenderAttr("src", `${blogAssetPath}/article-product.webp`)} alt=""><img${ssrRenderAttr("src", `${blogAssetPath}/article-gradient.webp`)} alt=""></figure><div class="blog-card-body"><p>${ssrInterpolate(article.category)}</p><h2>${ssrInterpolate(article.title)}</h2><a${ssrRenderAttr("href", article.href)}><span>Click Here</span><b aria-hidden="true">→</b></a></div></article>`);
      });
...
export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/blog-CeVU02yg');
//# sourceMappingURL=blog-CeVU02yg.mjs.map
