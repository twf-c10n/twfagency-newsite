globalThis.__timing__.logStart('Load chunks/build/index-Dos_dQjN');import { defineComponent, ref, mergeProps, unref, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(showIntro)) {
        _push(`<div class="intro" aria-hidden="true"><span class="brand-mark">TWF</span><p>Imagine Beyond The Limit</p><span class="intro-line"></span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<header class="${ssrRenderClass(["site-header", { scrolled: unref(headerScrolled) }])}"><span class="scroll-progress" aria-hidden="true"></span><nav class="nav shell" aria-label="Primary navigation"><a class="brand" href="#home" aria-label="TWF home"><span class="brand-mark">TWF</span></a><div class="${ssrRenderClass(["nav-links", { open: unref(menuOpen) }])}"><!--[-->`);
      ...
      _push(`<!--]--></div><a class="${ssrRenderClass(["nav-contact", { active: unref(activeSection) === "contact" }])}" href="/contact"${ssrRenderAttr("aria-current", unref(activeSection) === "contact" ? "page" : void 0)}>Contact</a><button class="menu-toggle" type="button"${ssrRenderAttr("aria-expanded", unref(menuOpen))} aria-label="Toggle navigation"><span></span><span></span></button></nav></header><main><section id="home" class="hero"><div class="hero-media" aria-hidden="true"><video class="hero-banner" autoplay muted loop playsinline preload="metadata"><source${ssrRenderAttr("src", _imports_0)} type="video/webm"></video><video class="hero-filter" autoplay muted loop playsinline preload="metadata"><source${ssrRenderAttr("src", _imports_1)} type="video/webm"></video></div><div class="shell hero-copy"><p class="pill" data-reveal style="${ssrRenderStyle({ "--delay": ".12s" })}"><span></span> Performance Creative Agency</p><h1 data-reveal style="${ssrRenderStyle({ "--delay": ".22s" })}">Imagine Beyond<br>The Limit</h1><p class="hero-description" data-reveal style="${ssrRenderStyle({ "--delay": ".34s" })}"> We empower digital dominance through high-content design, relentless performance optimization, and elite technical mastery. Future-forward solutions for high-growth innovators. </p><a class="cta-button" data-reveal style="${ssrRenderStyle({ "--delay": ".44s" })}" href="#contact">Let&#39;s Launch Your Project <b>+</b></a></div></section><section class="client-strip" aria-label="Our clients"><div class="logo-track" aria-hidden="true"><!--[-->`);
...
export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/index-Dos_dQjN');
//# sourceMappingURL=index-Dos_dQjN.mjs.map
