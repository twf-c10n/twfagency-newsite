...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main><section class="project-hero"><h1>Reach New Heights</h1><p> Elite technical mastery meets uncompromising aesthetic standards. We architect digital dominance for high-growth innovators. </p></section><section class="project-categories" aria-label="Project categories"><!--[-->`);
...
//# sourceMappingURL=project-DUDjLmbC.mjs.map
