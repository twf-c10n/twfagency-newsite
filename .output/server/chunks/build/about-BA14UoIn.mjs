globalThis.__timing__.logStart('Load chunks/build/about-BA14UoIn');import { defineComponent, ref, mergeProps, unref, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page about-figma-page" }, _attrs))}><header class="${ssrRenderClass(["site-header about-figma-header", { scrolled: unref(headerScrolled) }])}"><nav class="about-figma-nav" aria-label="Primary navigation"><a class="about-logo" href="/" aria-label="TWF home"><img${ssrRenderAttr("src", `${assetPath}/twf-logo.svg`)} alt="TWF"></a><div class="${ssrRenderClass(["nav-links about-figma-links", { open: unref(menuOpen) }])}"><!--[-->`);
...
export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/about-BA14UoIn');
//# sourceMappingURL=about-BA14UoIn.mjs.map
