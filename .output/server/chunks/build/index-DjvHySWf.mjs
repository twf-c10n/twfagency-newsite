globalThis.__timing__.logStart('Load chunks/build/index-DjvHySWf');import { _ as __nuxt_component_0 } from './SiteHeader-D9ODwCeG.mjs';
...
import { a as getMediaUrl, p as pickLocalizedText } from './api-OwmsrwqD.mjs';
import { h as usePageSeo, u as useHead, k as useRuntimeConfig } from './server.mjs';
...
const _imports_0 = publicAssetsURL("/assets/hero-gradient.webp");
const _imports_1 = publicAssetsURL("/assets/performance-bg.webp");
const _imports_2 = publicAssetsURL("/assets/triangle-performance-glow.webp");
const _imports_3 = publicAssetsURL("/assets/triangle-of-performance-figma.webp");
const _imports_4 = publicAssetsURL("/assets/orbit.webp");
const _imports_5 = publicAssetsURL("/assets/showreel-reference.webp");
const _imports_6 = publicAssetsURL("/assets/stellar-data.webp");
const _imports_7 = publicAssetsURL("/assets/kensento.webp");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    usePageSeo({
      ...
      description: "TWF is a high-end digital agency merging technical mastery with creativity and performance.",
      path: "/",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main><section class="home-intro-story" aria-label="TWF introduction"><div class="home-intro-bound"><div class="home-intro-stage"><section id="home" class="hero"><div class="hero-media" aria-hidden="true"><div class="media-skeleton hero-media-skeleton"></div><video class="hero-banner" autoplay muted loop playsinline preload="none"${ssrRenderAttr("poster", _imports_0)}><source data-src="/assets/banner.webm" type="video/webm"></video><video class="hero-filter" autoplay muted loop playsinline preload="none"${ssrRenderAttr("poster", _imports_0)}><source data-src="/assets/bg_filter.webm" type="video/webm"></video></div><div class="shell hero-copy"><p class="pill" data-reveal style="${ssrRenderStyle({ "--delay": ".12s" })}"><span></span> Performance Creative Agency</p><h1 data-reveal style="${ssrRenderStyle({ "--delay": ".22s" })}">Imagine Beyond<br>The Limit</h1><p class="hero-description" data-reveal style="${ssrRenderStyle({ "--delay": ".34s" })}"> We empower digital dominance through high-content design, relentless performance optimization, and elite technical mastery. Future-forward solutions for high-growth innovators. </p><a class="cta-button" data-reveal style="${ssrRenderStyle({ "--delay": ".44s" })}" href="/project">Let&#39;s Launch Your Project <b>+</b></a></div></section></div></div></section><section class="needs"><div class="narrow" data-reveal><p class="caption needs-caption">Built for brands that need more than visibility</p><h2 class="gradient-title">All your needs</h2><p> We are a high-end digital agency merging uncompromising technical mastery with unbounded creativity. For 15 years, we have engineered digital experiences for high-growth talent firms and luxury innovators. </p></div></section><section class="client-strip" aria-label="Our clients"><div class="logo-track" aria-hidden="true"><!--[-->`);
      ssrRenderList(2, (sequence) => {
        _push(`<div class="logo-set"><!--[-->`);
        ssrRenderList(clientLogos, (logo) => {
          _push(`<img class="brand-logo"${ssrRenderAttr("src", logo.src)}${ssrRenderAttr("alt", logo.label)} loading="lazy" decoding="async">`);
        });
        _push(`<!--]--></div>`);
      });
      _push(`<!--]--></div></section><section id="services" class="expertise"><div class="shell expertise-heading" data-reveal><div><p class="caption">Our Expertise</p><h2>Performance<br>Creative</h2></div><p> We dismantle the traditional agency model to build something faster, bolder, and more focused on your bottom line. No fluff, just kinetic impact. </p></div><div id="performance-creative-visual" class="performance-visual" aria-label="Triangle of Performance"><div class="performance-scene" data-reveal><picture class="performance-bg" aria-hidden="true"><source${ssrRenderAttr("srcset", _imports_1)} type="image/webp"><img${ssrRenderAttr("src", _imports_1)} alt="" loading="lazy" decoding="async"></picture><img class="performance-shards"${ssrRenderAttr("src", _imports_2)} alt="" aria-hidden="true" loading="lazy" decoding="async"><div class="performance-labels" aria-hidden="true"><span class="performance-label performance-label-1"><strong><!--[-->`);
      ...
      _push(`<!--]--></strong><span class="performance-label-subtitle">${ssrInterpolate(pillars[2].labelSubtitle)}</span></span></div><img class="performance-poster"${ssrRenderAttr("src", _imports_3)} alt="Triangle of Performance: TWF Agency Performance Creative" loading="lazy" decoding="async"><div class="poster-border" aria-hidden="true"></div></div></div><div class="pillar-grid"><!--[-->`);
      ...
      _push(`<!--]--></div></div><div class="orbit-art" data-reveal style="${ssrRenderStyle({ "--delay": ".18s" })}" aria-hidden="true"><img${ssrRenderAttr("src", _imports_4)} alt="" loading="lazy" decoding="async"></div></div></section><section id="photography" class="${ssrRenderClass(["showreel", { "is-active": unref(showreelActive) }])}"><div class="showreel-stage"><figure class="showreel-frame" data-reveal><div class="media-skeleton showreel-skeleton" aria-hidden="true"></div><img class="showreel-poster"${ssrRenderAttr("src", _imports_5)} alt="" aria-hidden="true" loading="lazy" decoding="async"><video muted loop playsinline preload="none"${ssrRenderAttr("poster", _imports_5)} aria-label="Capturing Vision. Executing Perfection. Watch 2026 showreel"><source data-src="/assets/showreel.mp4" type="video/mp4"></video></figure></div></section><section id="projects" class="products"><div class="shell products-inner"><p class="accent-copy" data-reveal>Venture Beyond Your Limits</p><h2 data-reveal style="${ssrRenderStyle({ "--delay": ".08s" })}">Our Innovative Product<br>and Services</h2><div class="product-grid"><article data-reveal style="${ssrRenderStyle({ "--delay": ".14s" })}"><img${ssrRenderAttr("src", _imports_6)} alt="Stellar Data" loading="lazy" decoding="async"><p>Elevate your performance marketing campaigns</p></article><article data-reveal style="${ssrRenderStyle({ "--delay": ".22s" })}"><img${ssrRenderAttr("src", _imports_7)} alt="Kensento" loading="lazy" decoding="async"><p>Taking you beyond cookies consent management</p></article></div></div></section><section id="about" class="team"><div class="team-media" aria-hidden="true"><video autoplay muted loop playsinline preload="none"><source data-src="/assets/background-1781079667180.webm" type="video/webm"></video></div><div class="shell team-grid"><div class="${ssrRenderClass(["team-photos", { "is-looping": unref(hasTrustPhotoLoop), "is-sliding": unref(isTrustSliding) }])}"><div class="team-photo-track"><figure class="team-photo-slide is-incoming" aria-hidden="true"><img${ssrRenderAttr("src", unref(trustIncomingPhoto).src)}${ssrRenderAttr("alt", unref(trustIncomingPhoto).alt)} loading="lazy" decoding="async"></figure><figure class="team-photo-slide is-top"><img${ssrRenderAttr("src", unref(trustTopPhoto).src)}${ssrRenderAttr("alt", unref(trustTopPhoto).alt)} loading="lazy" decoding="async"></figure><figure class="team-photo-slide is-bottom"><img${ssrRenderAttr("src", unref(trustBottomPhoto).src)}${ssrRenderAttr("alt", unref(trustBottomPhoto).alt)} loading="lazy" decoding="async"></figure></div><div class="team-photo-buffer" aria-hidden="true"><!--[-->`);
      ssrRenderList(unref(trustPhotos), (photo) => {
        _push(`<img${ssrRenderAttr("src", photo.src)}${ssrRenderAttr("alt", photo.alt)} loading="lazy" decoding="async">`);
      });
      _push(`<!--]--></div></div><div class="team-copy" data-reveal style="${ssrRenderStyle({ "--delay": ".14s" })}"><h2>A team you<br>can trust</h2><p>${ssrInterpolate(unref(trustDescription))}</p></div></div></section><section id="blog" class="articles"><div class="shell"><p class="caption" data-reveal>Our Expertise</p><h2 data-reveal style="${ssrRenderStyle({ "--delay": ".08s" })}">Explore our recent articles</h2><p class="article-tags" data-reveal style="${ssrRenderStyle({ "--delay": ".12s" })}">Performance Marketing · Social Media · Case Study · Media Plan &amp; Buy · Digital Campaign</p><div class="article-grid"><!--[-->`);
      ssrRenderList(unref(articles), (article, index) => {
        _push(`<article data-reveal style="${ssrRenderStyle({ "--delay": `${160 + index * 75}ms` })}"><a class="article-card-link"${ssrRenderAttr("href", article.href)}${ssrRenderAttr("target", article.href.startsWith("http") ? "_blank" : void 0)}${ssrRenderAttr("rel", article.href.startsWith("http") ? "noreferrer" : void 0)}${ssrRenderAttr("aria-label", `ดูบทความ ${article.title}`)}><img${ssrRenderAttr("src", article.image)}${ssrRenderAttr("alt", article.title)} loading="lazy" decoding="async"><div><p>${ssrInterpolate(article.authorName)}</p><h3>${ssrInterpolate(article.title)}</h3><span class="article-link">ดูบทความ <b>+</b></span></div></a></article>`);
      });
      _push(`<!--]--></div></div></section></main><footer id="contact" class="footer"><div class="footer-action" data-reveal><h2 class="gradient-title">Make your goals a reality</h2><a class="cta-button" href="/partnership" target="_blank">Initiate Project Launch <b>+</b></a></div><div class="shell footer-bottom"><img class="footer-logo"${ssrRenderAttr("src", `${aboutAssetPath}/twf-logo-footer.svg`)} alt="TWF"><p>The Web Flight Co., Ltd. Crystal Park Place Building, R.1<br>Praditmanutham Road, Wangthonglang, Bangkok 10310</p><div class="socials"><!--[-->`);
...
export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/index-DjvHySWf');
//# sourceMappingURL=index-DjvHySWf.mjs.map
