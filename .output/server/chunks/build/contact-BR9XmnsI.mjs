globalThis.__timing__.logStart('Load chunks/build/contact-BR9XmnsI');import { _ as __nuxt_component_0 } from './SiteHeader-D9ODwCeG.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    usePageSeo({
      ...
      description: "Start a partnership with The Web Flight Co., Ltd. Contact TWF Agency for digital marketing, creative, media, and growth services.",
      path: "/contact",
...
export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/contact-BR9XmnsI');
//# sourceMappingURL=contact-BR9XmnsI.mjs.map
