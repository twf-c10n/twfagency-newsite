globalThis.__timing__.logStart('Load chunks/build/photography-BzHRDnq8');import { _ as __nuxt_component_0 } from './SiteHeader-D9ODwCeG.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    usePageSeo({
      ...
      description: "Commercial photography, cinema-grade video production, short-form content, drone operations, VFX, and color finishing by TWF Agency.",
      path: "/photography",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page photography-page" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_SiteHeader, { "active-path": "/photography" }, null, _parent));
      _push(`<main><section class="photo-hero"><h1>Photography &amp;<br>Production</h1><p> We are a high-end digital agency merging uncompromising technical mastery with unbounded creativity. For 15 years, we have engineered digital experiences for high-growth tech firms and luxury innovators. </p></section><section class="photo-ticker" aria-label="Production capabilities"><div class="photo-ticker-track"><!--[-->`);
      ssrRenderList(2, (set) => {
        _push(`<!--[--><!--[-->`);
...
export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/photography-BzHRDnq8');
//# sourceMappingURL=photography-BzHRDnq8.mjs.map
