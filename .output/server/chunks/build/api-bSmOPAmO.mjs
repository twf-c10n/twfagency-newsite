globalThis.__timing__.logStart('Load chunks/build/api-bSmOPAmO');import { defineComponent, createElementBlock, shallowRef, getCurrentInstance, provide, cloneVNode, h, isRef, computed, toValue, onServerPrefetch, reactive, ref, nextTick, unref, toRef } from 'vue';
...
const getHomepage = () => getPageBySlug("homepage");
...
export { getHomepage as a, getMediaUrl as b, getOurProjectsPage as c, getProjectDetail as d, getContactUsPage as g, leadBudgetOptions as l, pickLocalizedText as p, useAsyncData as u };;globalThis.__timing__.logEnd('Load chunks/build/api-bSmOPAmO');
//# sourceMappingURL=api-bSmOPAmO.mjs.map
