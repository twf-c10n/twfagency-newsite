globalThis.__timing__.logStart('Load chunks/build/index-DJiKmOjj');import { _ as __nuxt_component_0 } from './SiteHeader-D9ODwCeG.mjs';
...
import { u as useAsyncData, a as getHomepage, b as getMediaUrl, p as pickLocalizedText } from './api-bSmOPAmO.mjs';
...
const _imports_1 = publicAssetsURL("/assets/banner.webm");
const _imports_2 = publicAssetsURL("/assets/performance-bg.webp");
const _imports_3 = publicAssetsURL("/assets/triangle-performance-glow.webp");
const _imports_4 = publicAssetsURL("/assets/triangle-of-performance-figma.webp");
const _imports_5 = publicAssetsURL("/assets/orbit.webp");
const _imports_6 = publicAssetsURL("/assets/showreel-reference.webp");
const _imports_7 = publicAssetsURL("/assets/stellar-data.webp");
const _imports_8 = publicAssetsURL("/assets/kensento.webp");
const _imports_9 = publicAssetsURL("/assets/background-1781079667180.webm");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></strong><span class="performance-label-subtitle">${ssrInterpolate(pillars[2].labelSubtitle)}</span></span></div><img class="performance-poster"${ssrRenderAttr("src", _imports_4)} alt="Triangle of Performance: TWF Agency Performance Creative" loading="lazy" decoding="async"><div class="poster-border" aria-hidden="true"></div></div></div><div class="pillar-grid"><!--[-->`);
      ...
      _push(`<!--]--></div></div><div class="orbit-art" data-reveal style="${ssrRenderStyle({ "--delay": ".18s" })}" aria-hidden="true"><img${ssrRenderAttr("src", _imports_5)} alt=""></div></div></section><section id="photography" class="${ssrRenderClass(["showreel", { "is-active": unref(showreelActive) }])}"><div class="showreel-stage"><figure class="showreel-frame" data-reveal><div class="media-skeleton showreel-skeleton" aria-hidden="true"></div><img class="showreel-poster"${ssrRenderAttr("src", _imports_6)} alt="" aria-hidden="true"><video muted loop playsinline preload="none"${ssrRenderAttr("poster", _imports_6)} aria-label="Capturing Vision. Executing Perfection. Watch 2026 showreel"><source data-src="/assets/showreel.mp4" type="video/mp4"></video></figure></div></section><section id="projects" class="products"><div class="shell products-inner"><p class="accent-copy" data-reveal>Venture Beyond Your Limits</p><h2 data-reveal style="${ssrRenderStyle({ "--delay": ".08s" })}">Our Innovative Product<br>and Services</h2><div class="product-grid"><article data-reveal style="${ssrRenderStyle({ "--delay": ".14s" })}"><img${ssrRenderAttr("src", _imports_7)} alt="Stellar Data"><p>Elevate your performance marketing campaigns</p></article><article data-reveal style="${ssrRenderStyle({ "--delay": ".22s" })}"><img${ssrRenderAttr("src", _imports_8)} alt="Kensento"><p>Taking you beyond cookies consent management</p></article></div></div></section><section id="about" class="team"><div class="team-media" aria-hidden="true"><video autoplay muted loop playsinline preload="metadata"><source${ssrRenderAttr("src", _imports_9)} type="video/webm"></video></div><div class="shell team-grid"><div class="${ssrRenderClass(["team-photos", { "is-looping": unref(hasTrustPhotoLoop), "is-sliding": unref(isTrustSliding) }])}"><div class="team-photo-track"><figure class="team-photo-slide is-incoming" aria-hidden="true"><img${ssrRenderAttr("src", unref(trustIncomingPhoto).src)}${ssrRenderAttr("alt", unref(trustIncomingPhoto).alt)}></figure><figure class="team-photo-slide is-top"><img${ssrRenderAttr("src", unref(trustTopPhoto).src)}${ssrRenderAttr("alt", unref(trustTopPhoto).alt)}></figure><figure class="team-photo-slide is-bottom"><img${ssrRenderAttr("src", unref(trustBottomPhoto).src)}${ssrRenderAttr("alt", unref(trustBottomPhoto).alt)}></figure></div><div class="team-photo-buffer" aria-hidden="true"><!--[-->`);
      ssrRenderList(unref(trustPhotos), (photo) => {
        _push(`<img${ssrRenderAttr("src", photo.src)}${ssrRenderAttr("alt", photo.alt)} decoding="async">`);
      });
...
export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/index-DJiKmOjj');
//# sourceMappingURL=index-DJiKmOjj.mjs.map
